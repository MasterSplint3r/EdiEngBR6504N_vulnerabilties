...
//if (hours == 0) hours = 12;
if (hours == 12 && minutes==0 && seconds == 0) setTimeout('document.location.href="stamenu.asp";',0);
...
<body class="subbg3" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" background="file/back-b2.gif" style="background-color: #000000" onLoad="funClock();" link="#FFFFFF" vlink="#FFFFFF">
...
<table width="180" border="0" cellspacing="0" cellpadding="0" height="90%">
	<tbody>
		<tr><td valign="top">
<!--***********-->
			<table width="180" marginwidth="2" border="0" cellspacing="0" cellpadding="0">
				<tbody><tr>
				...
				<tr>
					<td height="100" valign="top">
						<a href="stainfo.asp" target="main"><img src="file/r_2.gif" width="19" height="14" border="0" name="ImageR"><font face="Arial" size="4" class="menut"><script>dw(status)</script><br></font></a>
	<!--*********-->
...
<a href="stanet.asp" target="main"><font size="2" class="fontCr"><script>dw(statInternet)</script></a><br>

<img src="file/p6.gif" width="10" height="10" align="middle">
<a href="stadevice.asp" target="main"><font size="2" class="fontCr"><script>dw(statDevice)</script></a><br>

<img src="file/p6.gif" width="10" height="10" align="middle">
<a href="stasylog.asp" target="main"><font size="2" class="fontCr"><script>dw(statSystem)</script></a><br>

<img src="file/p6.gif" width="10" height="10" align="middle">
<a href="staslog.asp" target="main"><font size="2" class="fontCr"><script>dw(statSecurity)</script></a><br>

<img src="file/p6.gif" width="10" height="10" align="middle">
<a href="stadhcptbl.asp" target="main"><font size="2" class="fontCr"><script>dw(statDHCP)</script></a><br>

<img src="file/p6.gif" width="10" height="10" align="middle">
<a href="stats.asp" target="main"><font size="2" class="fontCr"><script>dw(statStatistics)</script></a><br>
</font></td>
</tr></tbody>
</table>
	<!--***********-->
...
<table height="200" align="center" border="0" width="150"><tr><td align="center">
<a href="stamenu.asp" target="lFrame"><font size="2" class="fontCr"><b><script>dw(currentTime)</script></b></a><br><font class="menut">
